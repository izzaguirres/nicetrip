  ...
  return (
    <Dialog open={open} onOpenChange={(value) => !saving && onOpenChange(value)}>
      ...
      <form className="flex max-h-[84vh] flex-col" onSubmit={handleSubmit}>
        <DialogHeader className="space-y-1 border-b border-white/70 bg-white/60 px-8 py-5 backdrop-blur-2xl">
          ...
          <p className="text-sm text-slate-500">
            Atualize informações oficiais antes de liberar para o Smart Filter.
          </p>
        </DialogHeader>
        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-8 py-6">
          <AdminSurface className="space-y-4 p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Dados principais</p>
                <p className="text-sm text-slate-500">Defina destino, data, transporte e capacidade.</p>
              </div>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="grid gap-2">
                ...
                <SingleSelectCombobox
                  ...
                  placeholder="Selecione ou digite a capacidade"
                  loading={lookupsLoading}
                  allowCustomValue
                  portalContainer={dialogContainer}
                />
          ...
          <AdminSurface className="space-y-4 p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Hospedagem</p>
                <p className="text-sm text-slate-500">Escolha hotel e categoria do quarto.</p>
              </div>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                <Label htmlFor="quarto_tipo">Tipo de quarto</Label>
                <SingleSelectCombobox
                  name="quarto_tipo"
          ...
          {!isAereo && (
            <AdminSurface className="space-y-4 p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Valores base (Bús)</p>
          ...
          {isAereo && (
            <AdminSurface className="space-y-4 p-6">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Valores específicos (Aéreo)</p>
              <div className="grid gap-3 md:grid-cols-4">
                {[
                  { id: 'preco_adulto_aereo', label: 'Adulto Aéreo', value: defaultValues.preco_adulto_aereo },
                  { id: 'preco_crianca_0_2_aereo', label: '0-2 Aéreo', value: defaultValues.preco_crianca_0_2_aereo },
                  { id: 'preco_crianca_2_5_aereo', label: '2-5 Aéreo', value: defaultValues.preco_crianca_2_5_aereo },
                  { id: 'preco_crianca_6_mais_aereo', label: '6+ Aéreo', value: defaultValues.preco_crianca_6_mais_aereo },
                ].map((field) => (
                  <div className="grid gap-1" key={field.id}>
                    <Label htmlFor={field.id} className="text-xs font-medium text-muted-foreground">
                      {field.label}
              ...
              <div className="grid gap-3 md:grid-cols-3">
                <div className="grid gap-1">
                  <Label htmlFor="taxa_aereo_por_pessoa" className="text-xs font-medium text-muted-foreground">
                    Taxa por pessoa
                  </Label>
                  <Input
          ...
          <AdminSurface className="space-y-4 p-6">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400">Duração</p>
            <div className="grid gap-3 md:grid-cols-3">
              <div className="grid gap-2">
                <Label htmlFor="noites_hotel">Noites</Label>
                <Input
                  id="noites_hotel"
                  name="noites_hotel"
                  type="number"
              ...
              <div className="grid gap-2">
                <Label htmlFor="dias_viagem">Dias de viagem</Label>
                <Input
                  id="dias_viagem"
                  name="dias_viagem"
                  type="number"
              ...
              <div className="grid gap-2">
                <Label htmlFor="dias_totais">Dias totais</Label>
                <Input
                  id="dias_totais"
                  name="dias_totais"
                  type="number"
        ...
        <DialogFooter className="flex flex-col gap-2 border-t border-white/60 bg-white/70 px-8 py-4 backdrop-blur-xl sm:flex-row sm:justify-end">
          <Button type="button" variant="outline" onClick={() => onOpenChange(false)} disabled={saving} className="rounded-full">
            Cancelar
          </Button>
          <Button type="submit" disabled={saving} className="rounded-full bg-gradient-to-br from-orange-400 to-orange-500 px-6 shadow-lg hover:from-orange-500 hover:to-orange-600">
