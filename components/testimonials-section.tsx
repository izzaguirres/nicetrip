  ...
  return (
    <section className="bg-gray-50 py-16 lg:py-24 relative">
      <div className="container z-10 mx-auto px-4 lg:px-[70px]">
        ...
        {/* Desktop - 3 Columns */}
        <FadeIn delay={0.3} className="hidden lg:flex justify-center gap-6 mt-12 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[740px] overflow-hidden">
        ...
        {/* Tablet - 2 Columns */}
        <FadeIn delay={0.3} className="hidden md:flex lg:hidden justify-center gap-6 mt-12 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[600px] overflow-hidden">
          <TestimonialsColumn testimonials={firstColumn} duration={15} />
          <TestimonialsColumn testimonials={secondColumn} duration={19} />
        </FadeIn>

        {/* Mobile - 1 Column */}
        <FadeIn delay={0.3} className="flex md:hidden justify-center mt-12 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[500px] overflow-hidden">
